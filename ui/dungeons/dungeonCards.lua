...
function UI:PopulateCard(cardContainer, card)
    ...
    local lootBtn = NextKey222.UIComponents:CreateNativeButton(cardFrame, "small")
    ...
    local dislikeBtn = NextKey222.UIComponents:CreateNativeButton(cardFrame, "small")
    dislikeBtn:SetText("-")
    ...
    local likeBtn = NextKey222.UIComponents:CreateNativeButton(cardFrame, "small")
    likeBtn:SetText("+")
